...
using ResourceClient.Models.AccountViewModels;
...
namespace ResourceClient.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            {
                var disco = await DiscoveryClient.GetAsync("https://localhost:44389");

                // request token
                var tokenClient = new TokenClient(disco.TokenEndpoint, "client", "secret");
                var tokenResponse = await tokenClient.RequestResourceOwnerPasswordAsync(model.Name, model.Password);
